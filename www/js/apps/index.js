    ...
    getFollowingInfo: function(code) {
        ...
        services.getInfoFromQrCode(code, function(result) {
            ...
            if(result.offerte && (result.offerte.length > 0)) {
                ...
                html += '<a href="#qrCodeInfoCommentsPage" class="ui-btn  ui-btn-qrcodeinfo ui-btn-comments">Commenti' + (totComments > 0 ? '&nbsp;<span style="color:#FF1111; background:#FFFFFF;  padding: 3px;  border-radius: 3px;  font-size: 0.8em!important;">' + totComments + '</span>' : '') + '</a>';
